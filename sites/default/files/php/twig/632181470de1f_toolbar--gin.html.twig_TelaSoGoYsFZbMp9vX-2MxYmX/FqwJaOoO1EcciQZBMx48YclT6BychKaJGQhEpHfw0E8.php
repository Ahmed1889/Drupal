...
class __TwigTemplate_5982dbc04e3e8db7aff97ef9c71bbdc76323c6f55e836cc2b76ccaae31e7f660 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["tab"], "attributes", [], "any", false, false, true, 33), "id", [], "any", false, false, true, 33) == "responsive-preview-toolbar-tab")))) {
                ...
                // line 38
                echo "        ";
                if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["tab"], "attributes", [], "any", false, false, true, 38), "id", [], "any", false, false, true, 38) == "toolbar-tab-tour")) {
                    // line 39
                    echo "        <div";
...
";
    ...
    {
        return new Source("", "themes/gin/templates/navigation/toolbar--gin.html.twig", "C:\\wamp64\\www\\mas\\themes\\gin\\templates\\navigation\\toolbar--gin.html.twig");
    }
